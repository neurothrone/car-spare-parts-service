...
# fill elements with possible product names and when generated will randomly
# select one of them in the list 'elements'
elements = []
...
# description for products is generated by the words in the list below
product_description_list = ["battery", "steering-wheel", "tail-light", "head-light"] + [
    "test1", "test2", "test3", "test4", "has", "a", "whatever"
]
