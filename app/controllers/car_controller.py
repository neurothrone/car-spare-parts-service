...
class CarController(BaseController):
    ...
    @classmethod
    def create(cls, reg_no: str, color: str, car_detail_id, customer_id) -> None:
        CarRepository.create(reg_no=reg_no, color=color, car_detail_id=car_detail_id, customer_id=customer_id)
